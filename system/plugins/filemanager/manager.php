...
if ($use_auth) {
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        unset($_SESSION[FM_SESSION_ID]['logged']);
        ?>
        <p>A valid session was not found!</p>
        <?php
        exit;
    }
}
...
<head>
    ...
    <?php endif; ?>
    <script src="<?php echo site_url; ?>/templates/_assets/js/libs/iframeResizer.contentWindow.min.js"></script>
</head>
<body class="<?php echo (FM_THEME == "dark") ? 'theme-dark' : ''; ?> <?php echo $isStickyNavBar; ?>">
<div id="wrapper" class="container-fluid" <?php if(isset($_GET["edit"])): ?>style="min-height: 900px;"<?php endif; ?>>
          ...
          <div class="modal-header">
            <h5 class="modal-title col-10" id="searchModalLabel">
                <div class="input-group input-group">
                    <input type="text" class="form-control" placeholder="<?php echo lng('Search') ?> a files" aria-label="<?php echo lng('Search') ?>" aria-describedby="search-addon3" id="advanced-search" required>
...
function lng($txt) {
    ...
    if (!strlen(is_null($lang) ? "" : $lang)) $lang = 'en';
